...
MyMesh::MyMesh()
{
	...
	max.x = -1000000000000000;
	max.y = -1000000000000000;
	max.z = -1000000000000000;
...
void MyMesh::computeAABB() {
	...
	{
		if (min.x > vertices[i * 3]) {
			min.x = vertices[i * 3];
		}
		if (min.y > vertices[i * 3 + 1]) {
			min.y = vertices[i * 3 + 1];
		}
		if (min.z > vertices[i * 3 + 2]) {
			min.z = vertices[i * 3 + 2];
		}
		if (max.x < vertices[i * 3]) {
			max.x = vertices[i * 3];
		}
		if (max.y < vertices[i * 3 + 1]) {
			max.y = vertices[i * 3 + 1];
		}
		if (max.z < vertices[i * 3 + 2]) {
			max.z = vertices[i * 3 + 2];
		}
	}
}
